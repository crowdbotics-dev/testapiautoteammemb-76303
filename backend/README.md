...
## Project Structure
    ...
    ├── testapiautoteammemb_76303  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76303`
...
2. Clone this repo and `cd testapiautoteammemb_76303`
